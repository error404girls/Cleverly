...
Make sure the correct answer isnt always b,the middle choice. Don't repeat the position of the correct answers. 
  ...
  lines.forEach((line) => {
    if(line.includes("|")) {
      ...
      if(parts.length>=2) {
        ...
        card.className = "card";
        card.dataset.questionIndex = totalQuestions;
        ...
        answers.forEach((answer) => {
          ...
          if(truthValue!==undefined) {
            ...
            option.addEventListener("click", ()=>handleAnswerClick(option, isCorrect, card));
...
//nu merge momentan 
const dingAudio = new Audio('sound/ding.ogg');
function playDingSound() {
  dingAudio.currentTime = 0;
  dingAudio.play();
}

function handleAnswerClick(option, isCorrect, card) {
