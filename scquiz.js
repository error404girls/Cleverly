...
function toggleDropdown() {
  ...
  const systemPrompt = `Always speak in the language the input is in,mostly romanian and english.Do not repeat the answer order. Do not put the corrcet answer in the middle always.33Do not number the questions or use any bold formatting. 
